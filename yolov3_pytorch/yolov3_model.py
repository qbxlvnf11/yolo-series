...
def create_modules(yolov3_channels, module_defs):
    """
    Constructs module list of layer blocks from module configuration in module_defs
    """
    
    output_filters = [yolov3_channels]
    module_list = nn.ModuleList()
    
    for module_i, module_def in enumerate(module_defs):
        
        #print('Type of module_def:', module_def["type"])
...
class Darknet(nn.Module):
    ...
    def __init__(self, module_defs, yolov3_channels):
        super(Darknet, self).__init__()
        
        self.module_defs = module_defs
        self.module_list = create_modules(yolov3_channels, self.module_defs)
